...
Applying OLS regression to the data, we get the coefficient estimates and MSE value:

```{r, echo=FALSE}
load(data/ols-saved-objects.Rdata)
library(xtable)

ols_summary_tbbl=xtable(summary_ols)
print(ols_summary_tbbl)
...
![](https://github.com/manuelhorta/stat159-fall2016-proj02/blob/master/images/ols_plots.png)
...
Applying Lasso regression to the data, we get the coefficient estimates and MSE value:

```{r, echo=FALSE}
load(data/data/lasso-saved-objects.Rdata)
library(xtable)

lasso_summary_tbbl=xtable(lasso_pred_full)
print(lasso_summary_tbbl)
...
![](https://github.com/manuelhorta/stat159-fall2016-proj02/blob/master/images/lasso_validation_plot.png)
